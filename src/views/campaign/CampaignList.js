...
const rows = [
  createData(1, 'Cupcake', 305, 3.7, 67, 4.3,"/view/campaign/selected-campaign"),
  createData(2, 'Donut', 452, 25.0, 51, 4.9,"/view/campaign/selected-campaign"),
...
export default function CampaignList() {
  ...
  return (
    <Box>
        ...
        <TextField id="outlined-basic" placeholder='Explore Influvencers' variant="outlined" sx={{width:"75%", borderColor:"#161a30", borderWidth:"2px"}} />
